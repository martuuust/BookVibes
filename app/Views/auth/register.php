...
<head>
    ...
    <title>Crear Cuenta - BookVibes</title>
    ...
    <style>
        :root {
            ...
            --secondary-gradient: linear-gradient(135deg, #2dd4bf 0%, #06b6d4 100%); /* Teal/Cyan for Register */
        ...
        @keyframes orbit {
            ...
            to { transform: rotate(-360deg) translateX(320px) rotate(360deg); } /* Counter-clockwise */
        }
        ...
        .btn-success:hover::after { left: 100%; }
        ...
        a { color: #2dd4bf; transition: color 0.2s; }
...
<div class="floating-container">
    ...
    <div class="orbiter" style="animation-duration: 22s;"><i class="bi bi-pen" style="font-size: 1.2rem;"></i></div>
    <div class="orbiter" style="animation-duration: 28s; animation-delay: -5s;"><i class="bi bi-music-player" style="font-size: 1.5rem;"></i></div>
    <div class="orbiter" style="animation-duration: 35s; animation-delay: -10s;"><i class="bi bi-bookmark-star" style="font-size: 1.3rem;"></i></div>
</div>
...
<div class="login-card">
    ...
    <p class="auth-subtitle">Únete y empieza tu viaje musical.</p>
    ...
    <form method="post" action="/register">
        <div class="mb-3">
            ...
            <div class="input-group">
                <span class="input-group-text" style="background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1); color: rgba(255,255,255,0.5);"><i class="bi bi-person"></i></span>
                <input type="text" id="username" name="username" class="form-control" placeholder="Tu nombre" required>
            </div>
        </div>
        ...
        <p class="text-center mb-0" style="color: rgba(255,255,255,0.6);">
            ¿Ya tienes una cuenta? <a href="/login" class="text-decoration-none fw-bold">Inicia Sesión</a>
        </p>
    </form>
</div>
