...
<head>
    <meta charset="UTF-8">
    <title>Registro - BookVibes</title>
    ...
    <style>
        ...
        .btn-success { font-weight: 700; border: none; box-shadow: 0 10px 24px rgba(34,197,94,0.35); }
    </style>
</head>
<body>
<div class="container">
            ...
            <div class="card p-4">
                ...
                <form method="post" action="/register">
                    ...
                    <div class="mt-3 text-center">
                        <a href="/login" class="text-light">Ya tengo cuenta</a>
                    </div>
                </form>
            </div>
        </div>
