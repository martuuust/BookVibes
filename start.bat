...
if exist "%PROJECT_ROOT%php\php.exe" (
  ...
  "%PROJECT_ROOT%php\php.exe" -d extension_dir="%PROJECT_ROOT%php\ext" -d extension=pdo_mysql -d extension=openssl -d extension=curl -d extension=mbstring -S 127.0.0.1:%PHP_PORT% -t public
) else (
